...
\title{A File Uploading System Implementation Based on STEP Protocol: Reliability, Robust and Performance\\
% {\footnotesize \textsuperscript{*}Note: Sub-titles are not captured in Xplore and
% should not be used}
\thanks{Thanks: Y3\_SEM1\_CAN201\_CW1 by kevinlasnh: https://github.com/kevinlasnh/Y3\_SEM1\_CAN201\_CW1}
}
 
\author{\IEEEauthorblockN{ Yaokai Yang}
